  ...
  return (
    <div className="flex flex-col gap-2">
      {skeletonTags.map((_, index) => (
        <div
          key={index}
          className="flex gap-2 items-center justify-center mb-2 bg-white/20 animate-pulse px-2 min-w-50 py-1.5 rounded-md"
        >
          {/* Tag name placeholder */}
          <div className="bg-gray-400/30 h-5 min-w-30 rounded" />
